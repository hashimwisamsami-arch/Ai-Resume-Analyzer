    ...
    <div className="min-h-screen bg-main-gradient p-4 sm:p-6 lg:p-8 flex items-center justify-center">
      <div className="max-w-5xl mx-auto w-full">
        <div className="text-center mb-6">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light bg-linear-to-r from-cyan-400 via-teal-200 to-sky-300 bg-clip-text text-transparent mb-2">
            AI Resume Analyzer
          </h1>
          ...
          <div className="space-y-6 p-4 sm:px-8 lg:px-16">
            <div className="file-info-card">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-4">
                  <div className="icon-container-xl bg-linear-to-br from-blue-500/20 to-cyan-500/20 border-blue-500/30">
            ...
            <div className="score-card">
              ...
              <p className="text-slate-400 text-sm mt-3 text-center font-medium">
                Score based on content quality,formating,and keyword usage.
              </p>
            </div>
                  ...
                  return (
                    <div key={i} className="group/item">
                      ...
                      <div className="progress-bar-small">
                        <div
                          className={`h-full bg-linear-to-r ${cfg.colorClass} rounded-full transition-all duration-100 ease-out group-hover/item:shadow-lg ${cfg.shadowClass}`}
            ...
            <div className="section-card group">
              <div className="flex items-center gap-3 mb-6">
                <div className="icon-container bg-pink-500/20">
                  ...
                  <div className="space-y-2">
                    {(
                      analysis.actionItems || [
                        "Optimize keyword placement for beeter ATS scoring",
            ...
            <div className="section-card group">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-violet-400 font-semibold text-xl">
                  ATS Optimization
                </h2>
              </div>
                ...
                <div className="flex items-start gap-3 mb-3">
                  <div>
                    ...
                    <p className="text-slate-200 text-sm leading-relaxed">
                      ...
                      is a software application used by employers and recruiters
                      to manage the hiring process. It helps collect, organize,
                      scan, filter, and rank resumes based on specific job
                      requirements, making it easier to identify qualified
            ...
            <div className="section-card group">
              ...
              <div className="info-box-blue">
                <p className="text-slate-300 text-sm leading-relaxed flex items-start gap-2">
                  ...
                  resume to improve ATS compatibility and increase your chanes
